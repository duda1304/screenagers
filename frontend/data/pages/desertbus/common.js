  ...
  segment: function(ctx, width, lanes, x1, y1, w1, x2, y2, w2, fog, color) {
    ...
    if (color.lane) {
      ...
      for(lane = 1 ; lane < lanes ; lanex1 += lanew1, lanex2 += lanew2, lane++)
        Render.polygon(ctx, lanex1 - l1, y1, lanex1 + l1, y1, lanex2 + l2, y2, lanex2 - l2, y2, color.lane);
    }
...
var COLORS = {
  ...
  TREE: '#005108',
  FOG:  '#005108',
  LIGHT:  { road: '#666666', grass: '#ff9900', rumble: '#996600', lane: '#cccc33'  },
  DARK:   { road: '#666666', grass: '#ff9900', rumble: '#cc6600'                   },
  START:  { road: '#666666',   grass: '#ff9900',   rumble: '#cc6600'                     },
  FINISH: { road: '#666666',   grass: '#ff9900',   rumble: '#cc6600'                     }
};
